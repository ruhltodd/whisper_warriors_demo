...
class GlobalExperienceLevelBar extends StatelessWidget {
  final bool smallSize; // ✅ HUD version should be minimal

  const GlobalExperienceLevelBar({this.smallSize = false, Key? key})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    int xpNeeded =
        PlayerProgressManager.getXpRequiredForLevel(currentLevel + 1);

    double progress = currentXp / xpNeeded;
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.circular(10),
                border:
                    Border.all(color: Colors.white, width: smallSize ? 0.5 : 1),
              ),
              child: Stack(
                children: [
